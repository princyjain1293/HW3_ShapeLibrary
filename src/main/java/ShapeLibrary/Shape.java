...
public abstract class Shape {
    ...
    public void saveShape(String fileName, Shape shape)
    {
        try{
...
//                return new Ellipse(Double.parseDouble(separatedText[1]), Double.parseDouble(separatedText[2]), Double.parseDouble(separatedText[3]), Double.parseDouble(separatedText[4]), Double.parseDouble(separatedText[5]), Double.parseDouble(separatedText[6]), Double.parseDouble(separatedText[7]), Double.parseDouble(separatedText[8]));
//            }
...
//                return new CompositeShape(separatedText);
//            }
